    ...
    <div className="h-full flex flex-col bg-[#0a0a12] font-mono text-sm">
      ...
      <div className="flex-1 p-4 overflow-auto">
        ...
        <div className="text-[#00ff88] mb-2">
          soufyane@SoufyaneOS:~$ ./contact.sh
        </div>
        ...
        {!isSubmitted ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#8888aa]">enter_name:</span>
              <input
                type="text"
                value={formData.name}
            ...
            <div className="flex items-center gap-2">
              <span className="text-[#00ff88]">$</span>
              <span className="text-[#8888aa]">enter_email:</span>
              <input
                type="email"
            ...
            <div className="flex items-center gap-2">
              <span className="text-[#00ff88]">$</span>
              <span className="text-[#8888aa]">enter_subject:</span>
              <input
                type="text"
          ...
          >
            ...
            <div className="text-[#00f0ff]">
              {`>`} Sending to soufyane@SoufyaneOS... OK
            </div>
            <div className="text-[#00ff88]">
              {`>`} Message delivered successfully ✓
            </div>
            <div className="mt-4 text-[#8888aa]">
            ...
            <button
              ...
              className="mt-2 text-[#555] hover:text-[#00f0ff] text-xs"
            >
